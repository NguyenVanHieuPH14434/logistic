...
import imgBackGround from '../../../assets/public/img/listGroceriesBackground.jpg'
...
function Deposit() {
    ...
    const handleOnClickDeleteList = (i) =>{
        let newList = [...list]
        newList.splice(i, 1)
        setList(newList)
        console.log(i);
    ...
    return (
        <>
            ...
            <div className="deposit">
                <img className="bg_deposit" src={imgBackGround} alt="" />
                <div className="content_deposit">
                    ...
                    <Table striped bordered hover size="lg">
                        ...
                        <tbody>
                            {list.map((li, i) => (
                                <tr key={i}>
                                    <td className="pt-5">  <span onClick={(i) => handleOnClickDeleteList(i)}>X</span> {i + 1} </td>
                                    <td>
                                        <img
